// Header File: UnsortedList_Arr_T.h
// Author: Antonio F. Huertas
// Date: October 11, 2007
// Purpose: Specification file for class template UnsortedList.
...
const int MAX_UNSORTED_SIZE = 10;
...
public:
	...
	// Post: The list contains the item and length is increased by 1.
	void insert(ItemType anItem);

	// Transformer: Removes an item from the list.
	// Pre: The list is not empty and contains the item.
	// Post: The list no longer contains the item and length is
	//       decreased by 1.
...
private:
	// Attributes
	ItemType items[MAX_UNSORTED_SIZE];
	int length;
	int currPosition;
...
#include "UnsortedList_Arr_T.cpp"
