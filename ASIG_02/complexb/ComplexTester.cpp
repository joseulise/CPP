...
void changeComplex(Complex& complex1)
{
	...
	cout<<"Complex Number has changed!!!"<<endl;
	system("pause");
}
...
void sumComplex(Complex complex1, Complex complex2)
{
	...
	tempComplex.setRealPart(complex1.getRealPart() + complex2.getRealPart());
	tempComplex.setImaginaryPart(complex1.getImaginaryPart() + complex2.getImaginaryPart());
